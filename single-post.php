    ...
    <div class="container">
        <div style="margin-top:-100px;position:absolute;display:flex;gap:20px;">
            ...
            <div class="hover-fade" style="display:flex;position:relative;">
                ...
                <div class="col-xs-6 col-sm-3 hover-fade myCard" style="width: 100%;border-radius:5px;overflow: hidden; display:flex;">
                    ...
                    ?>
                        <div class="play" style="">
                            ...
                            <a href="<?= $post->guid ?>" title="" style="background-color:transparent;">
                                <img src="https://img.icons8.com/fluency/48/000000/play-button-circled.png" style="width:45px;z-index:999;" />
                            </a>
